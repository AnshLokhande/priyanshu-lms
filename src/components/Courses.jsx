  ...
  return (
    <div className={`container mx-auto py-12 px-4 md:px-8 `}>
      ...
      <section className="mb-12">
        <h2 className="text-4xl font-bold mb-8 text-center">Popular Courses</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {popularCourses.map(course => (
            ...
            >
              ...
              >
                <h4 className="font-semibold text-sm text-white">{course.title}</h4>
                <p className="text-xs mt-1 text-white">{course.lastUpdated}</p>
                <p className="text-xs mt-2 text-white">{course.duration} total hours · {course.lectureCount} lectures · All Levels</p>
                <p className="text-xs mt-2 text-white">{course.description}</p>
                <ul className="text-xs mt-2 text-white">
