...
import Workshops from './Workshops';  // Import the Workshops page
import Internships from './Internships';  // Import the Internships page
      ...
      <ThemeContext.Provider value={{ isDarkMode, toggleTheme }}>
        <div className={`App ${isDarkMode ? 'bg-gray-900 text-gray-200' : 'bg-white text-black'}`}>
          ...
          <Routes>
            ...
            <Route path="/workshops" element={<Workshops />} />  {/* Workshops route added */}
            <Route path="/internship" element={<Internship />} />  {/* Internships route added */}
