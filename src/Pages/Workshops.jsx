...
const workshops = [
  {
    ...
    description: 'A workshop to enhance your creative writing skills.',
...
const Workshop = () => {
  ...
  return (
    <div className={`container mx-auto py-8 px-4 md:px-8 ${isDarkMode ? 'bg-gray-900 text-gray-200' : 'bg-white text-black'}`}>
            ...
            {filteredWorkshops.map(workshop => (
              ...
              >
                ...
                >
                  ...
                  <p className="text-xs mt-2">{workshop.duration} total hours · {workshop.lectureCount} lectures · All Levels</p>
